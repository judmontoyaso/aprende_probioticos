  ...
  return (
    <div className="bg-white rounded-lg shadow-md border border-gray-200 p-6 hover:shadow-lg transition-shadow duration-300">
      ...
      <div className="flex justify-between items-start mb-4">
        ...
        <div className={`px-2 py-1 rounded-full text-xs font-medium border ${getReliabilityColor(retailer.reliability || 'N/A')}`}>
          {retailer.reliability || 'N/A'}
        </div>
      </div>
      ...
      <div className="mb-4 space-y-2">
        ...
        {retailer.whatsapp && (
          <div className="flex items-center gap-2">
            ...
            <button 
              onClick={() => retailer.whatsapp && handleContactClick('whatsapp', retailer.whatsapp)}
              className="text-sm text-green-600 hover:text-green-700 hover:underline"
            >
              WhatsApp
            </button>
      ...
      {/* Probiotic Types */}
      {retailer.probioticTypes && retailer.probioticTypes.length > 0 && (
        <div className="mb-4">
      ...
      {/* Brands */}
      {retailer.brands && retailer.brands.length > 0 && retailer.brands[0] !== 'N/D (enfocado en alimentos)' && retailer.brands[0] !== 'N/A (productor directo)' && (
        <div className="mb-4">

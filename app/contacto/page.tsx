          ...
          <div className="mt-16 text-center">
            <div className="bg-gradient-to-r from-green-600 to-emerald-600 p-8 rounded-2xl text-white">
              ...
              <div className="flex flex-wrap justify-center gap-4">
                ...
                <Link href="/como-elegir" className="bg-green-700 text-white px-6 py-3 rounded-xl font-semibold hover:bg-green-800 transition-colors border border-green-500">

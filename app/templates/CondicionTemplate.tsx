      ...
      <div className="container mx-auto px-4 py-8 sm:py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <div className="mb-8 bg-red-50 border-2 border-red-200 p-6 rounded-lg">
              <div className="flex items-start">
                ...
                <div className="ml-3">
                  <h3 className="text-lg font-semibold text-red-800">Aviso Médico Importante</h3>
                  <p className="text-red-700 text-sm mt-1">
                    Esta información es únicamente educativa y no constituye consejo médico. 
                    Siempre consulte con un profesional de la salud antes de usar probióticos para tratar condiciones médicas.
                  </p>
                  <Link href="/descargo-responsabilidad" className="text-red-800 text-sm underline hover:text-red-900 mt-2 inline-block">
